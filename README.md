...
| `SCANNER_TRIVY_DB_REPOSITORY`           | `ghcr.io/aquasecurity/trivy-db`      | OCI repository to retrieve the trivy vulnerability database from                                                                                                                                                                                                                   |
| `SCANNER_TRIVY_JAVA_DB_REPOSITORY`      | `ghcr.io/aquasecurity/trivy-java-db` | OCI repository to retrieve the Java trivy vulnerability database from                                                                                                                                                                                                              |
